...
For departure_timezone and arrival_timezone: use IANA timezone identifiers, e.g. "America/Toronto", "Asia/Tokyo", "America/Santo_Domingo". Never use offset strings like "UTC-4" or "GMT-4" — always the IANA name.
